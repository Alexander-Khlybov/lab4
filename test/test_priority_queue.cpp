...
TEST(PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE, can_create_queue){
	PRIORITY_QUEUE<int>* a;
	ASSERT_NO_THROW(a = new PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE<int>());
}

TEST(PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE, created_queue_is_empty){
	PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE<int> a;
	EXPECT_EQ(1, a.isEmpty());
}

TEST(PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE, can_get_size_queue){
	PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE<int> a;
	ASSERT_NO_THROW(a.getSize());
}

TEST(PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE, getSize_works_properly){
	PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE<int> a;
	EXPECT_EQ(0, a.getSize());
}
...
TEST(PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE, push_increases_size){
	PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE<int> a;
	int tmp = a.getSize();
	a.push(1);
	EXPECT_EQ(tmp + 1, a.getSize());
...
TEST(PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE, pop_decreases_size){
	PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE<int> a;
	a.push(2);
	a.push(1);
	a.push(3);
...
TEST(PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE, back_dont_decrease_size){
	PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE<int> a;
	a.push(1);
	a.push(2);
	int tmp = a.getSize();
...
TEST(PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE, can_copy_queue){
	PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE<int> a;
	a.push(3);
	ASSERT_NO_THROW(PRIORITY_QUEUE_ON_BINARY_SEARCH_TREE<int> b(a));
}
